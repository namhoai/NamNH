 ...
 * @author HoaiNam
 */
public class PhieuXetNghiemFrm extends javax.swing.JFrame {

    /**
     * Creates new form PhieuXetNghiemFrm
     */
    public PhieuXetNghiemFrm() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PhieuXetNghiemFrm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PhieuXetNghiemFrm().setVisible(true);
            }
        });
    }
